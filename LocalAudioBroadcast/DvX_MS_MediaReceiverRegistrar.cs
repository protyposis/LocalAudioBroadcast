...
namespace LocalAudioBroadcast
{
    ...
    /// </summary>
    public class DvX_MS_MediaReceiverRegistrar : IUPnPService
    {
        ...
        private class _DvX_MS_MediaReceiverRegistrar
        {
            ...
            protected UPnPService BuildUPnPService()
            {
                ...
                RetVal[0] = new UPnPModeratedStateVariable("AuthorizationGrantedUpdateID", typeof(System.UInt32), true);
                RetVal[1] = new UPnPModeratedStateVariable("A_ARG_TYPE_Result", typeof(System.Int32), false);
                RetVal[1].AddAssociation("IsAuthorized", "Result");
                RetVal[1].AddAssociation("IsValidated", "Result");
                RetVal[2] = new UPnPModeratedStateVariable("ValidationRevokedUpdateID", typeof(System.UInt32), true);
                RetVal[3] = new UPnPModeratedStateVariable("A_ARG_TYPE_RegistrationReqMsg", typeof(System.Byte[]), false);
                RetVal[3].AddAssociation("RegisterDevice", "RegistrationReqMsg");
                RetVal[4] = new UPnPModeratedStateVariable("ValidationSucceededUpdateID", typeof(System.UInt32), true);
                RetVal[5] = new UPnPModeratedStateVariable("A_ARG_TYPE_DeviceID", typeof(System.String), false);
                RetVal[5].AddAssociation("IsAuthorized", "DeviceID");
                RetVal[5].AddAssociation("IsValidated", "DeviceID");
                RetVal[6] = new UPnPModeratedStateVariable("AuthorizationDeniedUpdateID", typeof(System.UInt32), true);
                RetVal[7] = new UPnPModeratedStateVariable("A_ARG_TYPE_RegistrationRespMsg", typeof(System.Byte[]), false);
                RetVal[7].AddAssociation("RegisterDevice", "RegistrationRespMsg");

                UPnPService S = new UPnPService(1, "urn:microsoft.com:serviceId:X_MS_MediaReceiverRegistrar", URN, true, this);
        ...
        public DvX_MS_MediaReceiverRegistrar(string ID):this()
        {
